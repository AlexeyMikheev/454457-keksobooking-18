...
(function () {
  ...
  var minMapX = mapPins.offsetLeft;
  var maxMapX = mapPins.offsetLeft + mapPins.offsetWidth - mapPinMain.offsetWidth;

  var mapFiltersContainer = document.querySelector('.map__filters-container');
  var pinTemplate = document.querySelector('#pin');

  var isMapEnabled = false;
  var draggedMapPinButton = null;
  ...
  var isAddressValid = function (address) {
    return address.x > minMapX && address.x < maxMapX && address.y > MIN_MAP_Y && address.y < MAX_MAP_Y;
  };
  ...
  var initMapPinMainEvents = function () {
    mapPinMain.addEventListener('mousedown', function (evt) {
      ...
      var onMouseMove = function (moveEvt) {
        ...
        dragged = true;
        draggedMapPinButton = mapPinMain;
